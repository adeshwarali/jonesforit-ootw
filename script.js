...
const menuButton = document.getElementById('menu');
    ...
    let isVideoVisible = true; // Initial state is visible

    menuButton.addEventListener('click', function () {
      if (isVideoVisible) {
        // If the video is currently visible, hide it
...
// // If notification, set it to a default value (e.g. , 0)
// if(likeCount === null){
//   likeCount = 0;
// } else{
//   likeCount = parseInt(likeCount);
// }
// // Display the like count on the page
...
const songs = [
  {
    title: "THE CRAWL",
    artist: "Jonesforit",
    img_src: "JonesForit_OOTW.png",
    src: "THE CRAWL2_DEMO.mp3",
  },
  {
    title: "THE WILDERNESS",
    artist: "Jonesforit",
    img_src: "JonesForit_OOTW.png",
    src: "THE WILDERNESS_DEMO.mp3",
  },
  {
    title: "THE CATERPILLAR",
    artist: "Jonesforit",
    img_src: "JonesForit_OOTW.png",
    src: "THE CATERPILLAR_DEMO.mp3", 
  },
  {
    title: "THE GAME",
    artist: "Jonesforit",
    img_src: "JonesForit_OOTW.png",
    src: "THE GAME_DEMO.mp3",
  },
  {
    title: "THE HAZE (feat. Reiona Meon)",
    artist: "Jonesforit",
    img_src: "JonesForit_OOTW.png",
    src: "THE HAZE_DEMO.mp3",
  },
  {
    title: "THE CALL",
    artist: "Jonesforit",
    img_src: "JonesForit_OOTW.png",
    src: "THE CALL_DEMO.mp3",
  },
  {
    title: "THE FREE",
    artist: "Jonesforit",
    img_src: "JonesForit_OOTW.png",
    src: "THE FREE_DEMO.mp3",
  },
  {
    title: "THE SWEET",
    artist: "Jonesforit",
    img_src: "JonesForit_OOTW.png",
    src: "THE SWEET_DEMO.mp3",
  },
  {
    title: "THE SWIM",
    artist: "Jonesforit",
    img_src: "JonesForit_OOTW.png",
    src: "THE SWIM_DEMO.mp3",
  },
  {
    title: "THE BEING",
    artist: "Jonesforit",
    img_src: "JonesForit_OOTW.png",
    src: "THE BEING_DEMO.mp3",
  },
];
...
function addToList(songs) {
  ...
  songs.forEach((song, index) => {
    ...
    const isFavourit = favourits.includes(index);
